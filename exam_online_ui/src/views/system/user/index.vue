  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <!-- <el-table-column label="用户代码" align="center" key="userCode" width="200" prop="userCode" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户名称" prop="nickName">
              <el-input v-model="form.nickName" placeholder="请输入用户名称"  maxlength="30" @blur="pinyinchange"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户账号" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入用户登录账号" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <!-- <el-row>
          <el-col :span="24">
            <el-form-item label="标注会场">
              <el-input v-model="form.remark" type="textarea" placeholder="会务接待人员需标注会场信息"></el-input>
            </el-form-item>
          </el-col>
        </el-row> -->
      </el-form>
...
export default {
  ...
  methods: {
    ...
    pinyinchange () {
      if (this.form.nickName !== undefined && this.form.nickName !== null && this.form.nickName.length > 0) {
